...
CREATE TABLE IF NOT EXISTS `AvaliaUnb`.`USUARIO` (
  ...
  `SENHA_SALT` VARCHAR(45) NOT NULL,
...
-- -----------------------------------------------------
-- Table `AvaliaUnb`.`HORARIO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `AvaliaUnb`.`HORARIO` (
  `TURMA_CODIGO` INT UNSIGNED NOT NULL,
  `TURMA_PERIODO_CODIGO` INT UNSIGNED NOT NULL,
  `TURMA_DISCIPLINA_CODIGO` INT UNSIGNED NOT NULL,
  ...
  INDEX `fk_HORARIO_TURMA1_idx` (`TURMA_CODIGO` ASC, `TURMA_PERIODO_CODIGO` ASC, `TURMA_DISCIPLINA_CODIGO` ASC) VISIBLE,
  PRIMARY KEY (`TURMA_CODIGO`, `TURMA_PERIODO_CODIGO`, `TURMA_DISCIPLINA_CODIGO`),
