...
CREATE TABLE IF NOT EXISTS `AvaliaUnb`.`TURMA` (
  ...
  `CODIGO_TXT` VARCHAR(10) NOT NULL,
  ...
  PRIMARY KEY (`CODIGO`, `PERIODO_CODIGO`, `DISCIPLINA_CODIGO`),
  ...
  INDEX `fk_TURMA_PROFESSOR1_idx` (`PROFESSOR_CODIGO` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `AvaliaUnb`.`AVALIACAO` (
  ...
  `TURMA_CODIGO` INT UNSIGNED NOT NULL,
  ...
  PRIMARY KEY (`USUARIO_MATRICULA`, `TURMA_CODIGO`, `TURMA_PERIODO_CODIGO`, `TURMA_DISCIPLINA_CODIGO`),
  INDEX `fk_AVALIACAO_USUARIO1_idx` (`USUARIO_MATRICULA` ASC) VISIBLE,
  INDEX `fk_AVALIACAO_TURMA1_idx` (`TURMA_CODIGO` ASC, `TURMA_PERIODO_CODIGO` ASC, `TURMA_DISCIPLINA_CODIGO` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_AVALIACAO_TURMA1`
    FOREIGN KEY (`TURMA_CODIGO` , `TURMA_PERIODO_CODIGO` , `TURMA_DISCIPLINA_CODIGO`)
    REFERENCES `AvaliaUnb`.`TURMA` (`CODIGO` , `PERIODO_CODIGO` , `DISCIPLINA_CODIGO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `AvaliaUnb`.`DENUNCIA` (
  ...
  `AVALIACAO_TURMA_CODIGO` INT UNSIGNED NOT NULL,
  ...
  INDEX `fk_DENUNCIA_AVALIACAO1_idx` (`AVALIACAO_USUARIO_MATRICULA` ASC, `AVALIACAO_TURMA_CODIGO` ASC, `AVALIACAO_TURMA_PERIODO_CODIGO` ASC, `AVALIACAO_TURMA_DISCIPLINA_CODIGO` ASC) VISIBLE,
  PRIMARY KEY (`USUARIO_MATRICULA`, `AVALIACAO_USUARIO_MATRICULA`, `AVALIACAO_TURMA_CODIGO`, `AVALIACAO_TURMA_PERIODO_CODIGO`, `AVALIACAO_TURMA_DISCIPLINA_CODIGO`),
  ...
  CONSTRAINT `fk_DENUNCIA_AVALIACAO1`
    FOREIGN KEY (`AVALIACAO_USUARIO_MATRICULA` , `AVALIACAO_TURMA_CODIGO` , `AVALIACAO_TURMA_PERIODO_CODIGO` , `AVALIACAO_TURMA_DISCIPLINA_CODIGO`)
    REFERENCES `AvaliaUnb`.`AVALIACAO` (`USUARIO_MATRICULA` , `TURMA_CODIGO` , `TURMA_PERIODO_CODIGO` , `TURMA_DISCIPLINA_CODIGO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `AvaliaUnb`.`TURMA_DIA` (
  ...
  `TURMA_PERIODO_CODIGO` INT UNSIGNED NOT NULL,
  `TURMA_DISCIPLINA_CODIGO` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`CODIGO`, `TURMA_CODIGO`, `TURMA_PERIODO_CODIGO`, `TURMA_DISCIPLINA_CODIGO`),
  INDEX `fk_TURMA_DIA_TURMA1_idx` (`TURMA_CODIGO` ASC, `TURMA_PERIODO_CODIGO` ASC, `TURMA_DISCIPLINA_CODIGO` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `AvaliaUnb`.`TURMA_HORARIO` (
  ...
  `TURMA_DISCIPLINA_CODIGO` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`CODIGO`, `TURMA_CODIGO`, `TURMA_PERIODO_CODIGO`, `TURMA_DISCIPLINA_CODIGO`),
  INDEX `fk_TURMA_HORARIO_TURMA1_idx` (`TURMA_CODIGO` ASC, `TURMA_PERIODO_CODIGO` ASC, `TURMA_DISCIPLINA_CODIGO` ASC) VISIBLE,
